...
urlpatterns = patterns('',
    ...
    url(r'^pageperm$', views.pageperm, name='pageperm'),
    url(r'^page1$', TemplateView.as_view(template_name='game/1.html'), name='page1'),
    ...
    url(r'^culprit/(?P<name>\w+)/$', views.culprit, name='culprit'),
    url(r'^culprit/$', views.culprit, name='culprit'),
